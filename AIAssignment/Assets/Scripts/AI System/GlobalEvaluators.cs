...
namespace Assets.Scripts.AI_System
{
    class GlobalEvaluators
    {
        ...
        public static float Evaluator_DistanceToObject (GameObject agent, GameObject obj)
        {
        ...
        /// <returns>A normalised value between a range of 0-1 representing the desirability.</returns>
        public static float Evaluator_DistanceToPosition (GameObject agent, Vector3 position)
        {
        ...
        public static float Evaluator_CurrentScore (AI agent)
        {
        ...
        public static float Evaluator_NumberOfEnemies (AI agent)
        {
        ...
        /// <returns>The clamped and normalised value between 0 - 1</returns>
        public static float Evaluator_NumberOfFriendliesInSight (AI agent)
        {
            const float half = 0.5f;
            float desirability = 0.0f;
        ...
        public static float Evaluator_NumberOfFriendliesAtPosition (AI agent, Vector3 position)
        {
            const float half = 0.5f;
            float desirability = 0.0f;
